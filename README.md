...
**tax_calc.py**: Core Tax Liability. Calculates Adjusted Gross Income (AGI), Taxable Income (using Standard Deduction), and Gross Tax Liability using the progressive bracket system.

**credits**: Contains 20 individual scripts for calculating specific, complex tax credits, including phase-outs and limits.
